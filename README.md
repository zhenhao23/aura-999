...
Unlike traditional emergency systems that rely solely on audio, WhateverClicks uses Gemini 2.0's native multimodal capabilities to process video, audio, and screen sharing simultaneously. This provides dispatchers with unprecedented situational awareness.

### 2. **Seamless Human-AI Collaboration**

The AI doesn't replace dispatchers—it augments them. Shadow Mode ensures the AI continues providing value even after handoff, acting as a second pair of eyes that never misses critical details.

### 3. **Built for Malaysia's Linguistic Diversity**

Manglish support isn't just translation—it understands code-switching patterns unique to Malaysian communication styles. The system recognizes that "You kat mana?" is more natural than a literal translation.

### 4. **Real-Time Intelligence, Not Batch Processing**

Using WebSocket streaming and Firebase real-time listeners, every update appears instantly. There's no polling, no delays—just immediate awareness of changing situations.

### 5. **Production-Ready Architecture**

- Memory-safe WebRTC connection handling
- Proper cleanup and error handling
- TypeScript strict mode throughout
- Scalable Firebase subcollection structure
...
- **Bidirectional Streaming**: Simultaneous audio input/output
- **Function Calling**: Structured data extraction from natural conversation
- **Context Management**: Multi-turn conversation with state preservation
- **Tool Switching**: Phase 1 (screening) → Phase 2 (observation) tools

### WebRTC Implementation

- **Firebase Signaling**: ICE candidate and SDP exchange
- **Connection Recovery**: Retry logic for failed connections
- **Memory Management**: Proper peer connection cleanup
- **Multi-Device Support**: Works across desktop/mobile browsers

### Firebase Architecture

- **Subcollections for Scale**: Prevents document size limits
- **Real-Time Listeners**: Live updates without polling
- **Optimistic UI**: Immediate feedback before server confirmation
- **Security Rules**: Test mode for hackathon, easily upgradeable
...
- [ ] Caller location tracking with GPS coordinates
- [ ] Historical incident dashboard with analytics
- [ ] Multi-incident management (tabs/queue system)
- [ ] Audio transcription display alongside video
- [ ] Resource availability status board

### Medium-Term

- [ ] Integration with actual Malaysian emergency services APIs
- [ ] Stress detection from voice analysis (pitch, tone, speaking rate)
- [ ] Automated dispatch recommendations based on historical data
- [ ] Mobile app for field responders
- [ ] SMS fallback for low-bandwidth scenarios

### Long-Term Vision

- [ ] Predictive resource positioning based on time/location patterns
- [ ] Cross-agency collaboration tools
- [ ] Public safety announcements via integrated SMS/push notifications
- [ ] Training mode with synthetic emergency scenarios
- [ ] Integration with smart city infrastructure (traffic cameras, IoT sensors)

---

## 🤝 Contributing

This project was built for KitaHack 2026. Contributions, issues, and feature requests are welcome!
...
- Follow Prettier formatting (auto-formats on save)
...
Built with ❤️ for KitaHack 2026 Google Hackathon

**Mission**: Revolutionize emergency response for Malaysia's diverse communities using cutting-edge AI technology.

---

## 🙏 Acknowledgments

- **Google Gemini Team** - For the incredible 2.0 Flash Live API
- **Firebase Team** - For reliable real-time infrastructure
- **Shadcn** - For beautiful, accessible UI components
- **Malaysian Emergency Services** - For inspiring this solution
...
- Check [SETUP-GUIDE.md](SETUP-GUIDE.md) for detailed setup instructions
- Review [FIREBASE-SETUP.md](FIREBASE-SETUP.md) for Firebase configuration

---

**WhateverClicks** - Because every second counts in an emergency. 🚨
